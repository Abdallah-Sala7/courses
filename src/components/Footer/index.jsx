      ...
      <div className="container">
        ...
        <div className="footer-links">
          <div className="footer-links-box">
            <h1 className="footer-box-title">About</h1>
          ...
          <div className="footer-links-box">
            <h1 className="footer-box-title">categories</h1>
          ...
          <div className="footer-links-box">
            <h1 className="footer-box-title">support</h1>
          ...
          <div className="footer-search-box">
            <h1 className="footer-box-title">subscribe</h1>
