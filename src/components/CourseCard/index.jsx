        ...
        <div className="course-card-details">
          <div className="constructor">
            <div className="constructor-img">
              <img
                src={'https://images.unsplash.com/photo-1616161610003-8b8b2b2b2b1c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80'}
                alt='course'
                loading='lazy'
              />
            </div>
